...
public static class ConcurrencyTasks
{
    /// <summary>
...
public class MultithreadingTask1
{
    public static async Task GO()
    {
        ...
        var results = await ConcurrencyTasks.FetchAllAsync(uris, SimFetch, maxConcurrency: 2, cts.Token);
        ...
        try
        {
            ...
            await ConcurrencyTasks.FetchAllAsync(urisFail, SimFetchFail, maxConcurrency: 3, failCts.Token);
