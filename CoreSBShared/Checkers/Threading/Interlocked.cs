namespace CoreSBShared.Universal.Checkers.Threading
{
    ...
    // Interlocked.CompareExchange(ref _valueToWriteTo, valueToWrite, valueToCompareWIth) => return initial
    public sealed class BoundedCounterSimple
    {
        // 1️⃣ Backing field
        // - Automatically zero-initialized by CLR
        // - Must NOT be volatile when using Interlocked
        private int _count;

        // 2️⃣ Upper bound (immutable)
        private const int Max = 1000;

        // 3️⃣ Constructor (optional explicit init for clarity)
        public BoundedCounterSimple(int initial = 0)
        {
        ...
        // 4️⃣ Lock-free bounded increment
        public bool TryIncrement()
        {
            ...
            do
            {
                ...
                // CAS: attempt to publish new value
